...
retainAsPublished:(BOOL)retainAsPublished
  retainHandling:(MQTTRetainHandling)retainHandling {
    ...
    while (!self.timedout) {
        MQTTLogDefault("Waiting for newMessages %ld/%ld retainedMessages %ld/%ld",
