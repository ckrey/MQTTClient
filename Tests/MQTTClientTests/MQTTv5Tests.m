...
- (void)test_maximumQos_available {
    ...
    MQTTLogDefault("Server Maximum QoS: %@", self.session.maximumQoS);
...
- (void)test_retain_available {
    ...
    MQTTLogDefault("Server Retain Available: %@", self.session.retainAvailable);
    BOOL retain = TRUE;
...
- (void)test_wildcardAvailable_available {
    ...
    MQTTLogDefault("Server Wildcard Subcription Available: %@", self.session.wildcardSubscriptionAvailable);
    BOOL wildcard = TRUE;
